...
書くだけ。検証を挟まない誤りの伝播は増幅する — 検証なしの独立並列で 17.2 倍、網目状で
7.8 倍、検証ボトルネックを持つ中央集権型で 4.4 倍
（[arXiv 2512.08296](https://arxiv.org/abs/2512.08296) Table 5）。本システムは座長（人間）を
唯一の検証点とする中央集権型で、席同士の伝言ゲームを構造的に排除している。
