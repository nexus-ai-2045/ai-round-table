...
原典 [Towards a Science of Scaling Agent Systems, arXiv:2512.08296v3](https://arxiv.org/abs/2512.08296v3)
（v3: 2026-04-08改訂、2026-09-06確認）を読み直した結果:
...
D1 (司会 = 人間) は撤回しない。根拠を**構造の話に置き換える**。席同士の直接通信と
dispatcher による要約・言い換えは実装しない。一方、後から dispatch された席は共有議事録を介して
先に merge された意見を読むため、席間の情報経路そのものが無いとは主張しない。
